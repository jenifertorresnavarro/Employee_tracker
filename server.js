...
connection.connect((err) => {
    if (err) throw err;
    //this will give us the message that the database connection was successfull 
console.log("Connected to the database!");
  start();
});

// cfont was used for the fancy title, this is all of its styling
...
// this will ask the user questions depending on what action they choose. 
function start() {
    inquirer
        .prompt({
            type: "list",
        ...
        connection.query(
            ...
            (error, results) => {
                ...
                inquirer
                    ...
                    .then((answers) => {
                        // Insert the employee into the database when user wants new employee
                        const sql =
